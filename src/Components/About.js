...
const About = () => {
  ...
  return (
    <>
      ...
      <div style={{ backgroundColor: "rgb(156 255 214)",color:"black" }}>
      ...
      <div style={{ backgroundColor: "#101069",color: "white" }} className="my-1">
        ...
        <h3 style={{ backgroundColor: "rgb(156 255 214)",color:"black" }} align="center"> Send Mail: <a href="mailto:vickyjha256@gmail.com">Click to send mail</a> </h3>
    </>
  )
}
